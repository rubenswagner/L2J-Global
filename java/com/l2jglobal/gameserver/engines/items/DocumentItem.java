 ...
 */
package com.l2jglobal.gameserver.engines.items;
...
import com.l2jglobal.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase implements IGameXmlReader
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			final Constructor<?> itemClass = Class.forName("com.l2jglobal.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
