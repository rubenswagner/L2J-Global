 ...
 */
package com.l2jglobal.gameserver.engines;
...
import com.l2jglobal.gameserver.model.base.PlayerState;
import com.l2jglobal.gameserver.model.conditions.Condition;
import com.l2jglobal.gameserver.model.conditions.ConditionCategoryType;
import com.l2jglobal.gameserver.model.conditions.ConditionChangeWeapon;
import com.l2jglobal.gameserver.model.conditions.ConditionGameChance;
import com.l2jglobal.gameserver.model.conditions.ConditionGameTime;
import com.l2jglobal.gameserver.model.conditions.ConditionGameTime.CheckGameTime;
import com.l2jglobal.gameserver.model.conditions.ConditionLogicAnd;
import com.l2jglobal.gameserver.model.conditions.ConditionLogicNot;
import com.l2jglobal.gameserver.model.conditions.ConditionLogicOr;
import com.l2jglobal.gameserver.model.conditions.ConditionMinDistance;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerActiveEffectId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerActiveSkillId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerAgathionId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCallPc;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanCreateBase;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanEscape;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanRefuelAirship;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanResurrect;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanSummonPet;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanSummonServitor;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanSummonSiegeGolem;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanSweep;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanSwitchSubclass;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanTakeCastle;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanTakeFort;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanTransform;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCanUntransform;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCharges;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCheckAbnormal;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerClassIdRestriction;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCloakStatus;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerCp;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerDualclass;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerFlyMounted;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerGrade;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasCastle;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasClanHall;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasFort;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasFreeSummonPoints;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasFreeTeleportBookmarkSlots;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasPet;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHasSummon;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerHp;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerImmobile;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerInInstance;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerInsideZoneId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerInstanceId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerInvSize;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerIsClanLeader;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerIsHero;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerIsInCombat;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerIsOnSide;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerIsPvpFlagged;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerLandingZone;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerLevel;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerLevelRange;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerMp;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerPkCount;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerPledgeClass;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerRace;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerRangeFromNpc;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerRangeFromSummonedNpc;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerServitorNpcId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerSex;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerSiegeSide;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerSouls;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerState;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerSubclass;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerTransformationId;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerVehicleMounted;
import com.l2jglobal.gameserver.model.conditions.ConditionPlayerWeight;
import com.l2jglobal.gameserver.model.conditions.ConditionSiegeZone;
import com.l2jglobal.gameserver.model.conditions.ConditionSlotItemId;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetAbnormalType;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetActiveEffectId;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetActiveSkillId;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetAggro;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetCheckCrtEffect;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetClassIdRestriction;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetInvSize;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetLevel;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetLevelRange;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetMyPartyExceptMe;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetNpcId;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetNpcType;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetPlayable;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetPlayer;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetRace;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetUsesWeaponKind;
import com.l2jglobal.gameserver.model.conditions.ConditionTargetWeight;
import com.l2jglobal.gameserver.model.conditions.ConditionUsingItemType;
import com.l2jglobal.gameserver.model.conditions.ConditionUsingSkill;
import com.l2jglobal.gameserver.model.conditions.ConditionUsingSlotType;
import com.l2jglobal.gameserver.model.conditions.ConditionWithSkill;
...
import com.l2jglobal.gameserver.model.skills.EffectScope;
import com.l2jglobal.gameserver.model.skills.Skill;
import com.l2jglobal.gameserver.model.stats.Stats;
import com.l2jglobal.gameserver.model.stats.functions.FuncTemplate;
