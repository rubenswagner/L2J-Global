 ...
 */
package com.l2jglobal.gameserver.model.quest;
...
import com.l2jglobal.gameserver.enums.QuestType;
import com.l2jglobal.gameserver.enums.Race;
import com.l2jglobal.gameserver.enums.TrapAction;
import com.l2jglobal.gameserver.instancemanager.QuestManager;
import com.l2jglobal.gameserver.model.KeyValuePair;
...
import com.l2jglobal.gameserver.model.base.AcquireSkillType;
import com.l2jglobal.gameserver.model.base.ClassId;
import com.l2jglobal.gameserver.model.events.AbstractScript;
...
import com.l2jglobal.gameserver.model.holders.NpcLogListHolder;
...
import com.l2jglobal.gameserver.model.olympiad.CompetitionType;
import com.l2jglobal.gameserver.model.olympiad.Participant;
...
import com.l2jglobal.gameserver.network.serverpackets.ExQuestNpcLogList;
import com.l2jglobal.gameserver.network.serverpackets.NpcHtmlMessage;
import com.l2jglobal.gameserver.network.serverpackets.NpcQuestHtmlMessage;
...
public class Quest extends AbstractScript implements IIdentifiable
{
	...
	{
		return ((target == null) || com.l2jglobal.gameserver.util.Util.checkIfInRange(1500, player, target, true));
	}
	 ...
	 * @return the HTML
	 */
	public String getStartConditionHtml(L2PcInstance player, L2Npc npc)
	{
	 ...
	 */
	@SafeVarargs
	public final void addCondStart(Predicate<L2PcInstance> questStartRequirement, KeyValuePair<Integer, String>... pairs)
	{
