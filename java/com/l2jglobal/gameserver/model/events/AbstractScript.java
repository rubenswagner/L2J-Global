...
import com.l2jglobal.gameserver.data.xml.impl.DoorData;
import com.l2jglobal.gameserver.data.xml.impl.NpcData;
import com.l2jglobal.gameserver.datatables.ItemTable;
import com.l2jglobal.gameserver.enums.AttributeType;
import com.l2jglobal.gameserver.enums.Movie;
import com.l2jglobal.gameserver.enums.QuestSound;
...
import com.l2jglobal.gameserver.instancemanager.PcCafePointsManager;
...
import com.l2jglobal.gameserver.model.actor.instance.L2DoorInstance;
...
import com.l2jglobal.gameserver.model.actor.instance.L2TrapInstance;
...
import com.l2jglobal.gameserver.model.events.annotations.Id;
import com.l2jglobal.gameserver.model.events.annotations.Ids;
import com.l2jglobal.gameserver.model.events.annotations.NpcLevelRange;
import com.l2jglobal.gameserver.model.events.annotations.NpcLevelRanges;
import com.l2jglobal.gameserver.model.events.annotations.Priority;
import com.l2jglobal.gameserver.model.events.annotations.Range;
import com.l2jglobal.gameserver.model.events.annotations.Ranges;
...
import com.l2jglobal.gameserver.model.events.listeners.AbstractEventListener;
import com.l2jglobal.gameserver.model.events.listeners.AnnotationEventListener;
import com.l2jglobal.gameserver.model.events.listeners.ConsumerEventListener;
import com.l2jglobal.gameserver.model.events.listeners.DummyEventListener;
import com.l2jglobal.gameserver.model.events.listeners.FunctionEventListener;
import com.l2jglobal.gameserver.model.events.listeners.RunnableEventListener;
...
import com.l2jglobal.gameserver.model.events.timers.IEventTimerCancel;
import com.l2jglobal.gameserver.model.events.timers.IEventTimerEvent;
import com.l2jglobal.gameserver.model.events.timers.TimerHolder;
...
import com.l2jglobal.gameserver.model.interfaces.IPositionable;
...
import com.l2jglobal.gameserver.model.items.enchant.attribute.AttributeHolder;
...
import com.l2jglobal.gameserver.model.spawns.SpawnGroup;
import com.l2jglobal.gameserver.model.spawns.SpawnTemplate;
...
import com.l2jglobal.gameserver.network.serverpackets.PlaySound;
import com.l2jglobal.gameserver.network.serverpackets.SpecialCamera;
import com.l2jglobal.gameserver.network.serverpackets.SystemMessage;
import com.l2jglobal.gameserver.scripting.ManagedScript;
import com.l2jglobal.gameserver.util.MinionList;
...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	...
	/**
	 * Provides instant callback operation when {@link com.l2jglobal.gameserver.model.actor.L2Character} Enters on a {@link L2ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link com.l2jglobal.gameserver.model.actor.L2Character} Exits on a {@link L2ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link com.l2jglobal.gameserver.model.actor.instance.L2TrapInstance} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link com.l2jglobal.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link com.l2jglobal.gameserver.GameTimeController}.
	 */
