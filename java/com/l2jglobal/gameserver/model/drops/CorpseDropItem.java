...
public class CorpseDropItem extends GeneralDropItem
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jglobal.gameserver.model.drops.GeneralDropItem#getGlobalAmountMultiplier()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jglobal.gameserver.model.drops.GeneralDropItem#getGlobalChanceMultiplier()
	 */
	@Override
