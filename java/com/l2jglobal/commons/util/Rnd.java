 ...
 */
package com.l2jglobal.commons.util;
...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see com.l2jglobal.commons.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link com.l2jglobal.commons.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see com.l2jglobal.commons.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see com.l2jglobal.commons.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return int
	 * @see com.l2jglobal.commons.util.Rnd#get(int n)
	 */
